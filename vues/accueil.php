...
<main role="main">
  ...
  <div class="album py-5 " style="background-color: rgb(106, 6, 6);">
  <div class="container">
    ...
    <div class="col-md-3">
      <div class="card mb-4 shadow-sm">
        ...
        <div class="card-body">
          <p class="card-text"><a href="index.php?uc=continents&action=list">Bibliothèque des continents</a></p>
    ...
    <div class="col-md-3">
      ...
      <div class="col-md-3">
        <div class="card mb-4 shadow-sm">
          <img src="image/livre.webp"><text>Livres</text>
          <div class="card-body">
            <p class="card-text"><a href="index.php?uc=livres&action=list">Bibliothèque des livres</a></p>
            <div class="d-flex justify-content-between align-items-center">
              <div class="btn-group">
                <button type="button" class="btn btn-sm btn-outline-secondary">View</button>
                <button type="button" class="btn btn-sm btn-outline-secondary">Edit</button>
